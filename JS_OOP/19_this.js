...
algo()// this es global.process (Node) o window (Browser)
...
o.algo() // this es el objeto que pertenece el metodo


// Constructora

const nuevo = new algo() // this es el nuevo objeto 
...
setTimeout(persona.saludarArrow, 2000)
