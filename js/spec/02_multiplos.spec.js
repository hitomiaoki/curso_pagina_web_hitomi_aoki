...
describe('Funcion isMultiplo', () => {
   ...
   it('should be false that 20 is Multiple of 2', () => {  
       expect(f.isMultiplo(20,2)).toBeFalsy()
   ...
   it('should be false that 21 is Multiple of 3', () => {  
       expect(f.isMultiplo(21,3)).toBeFalsy()
   ...
   it('should be false that 5 is Multiple of 2.5', () => {  
       expect(f.isMultiplo(5,2.5)).toBeFalsy()
   
   });   

   it('should be false that 7.5 is Multiple of 2.5', () => {  
       expect(f.isMultiplo(7.5,2.5)).toBeFalsy()
   
   });   

   it('should be error if "pepe" is Multiple of 2)', () => {  
       expect( () => f.isMultiplo('pepe',2))
